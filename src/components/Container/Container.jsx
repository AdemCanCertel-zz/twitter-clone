...
export default function ContainerPage() {
    return(
        <>
            <header className="flex justify-between items-center p-4 border-b border-primary-container_border_color bg-black">
            ...
            <div className="flex space-x-4 px-5 py-2 border-b border-primary-container_border_color">
                    <img className="rounded-full h-11 w-11" src="https://pbs.twimg.com/profile_images/1439646648410464258/C52zZ4ff_400x400.jpg"/>
                    <TweetBox/>
            </div>
            <div>
                    <Tweets/>
